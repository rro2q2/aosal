...
class DataPreprocessor:
    ...
    def prepare_dataset(self):
        ...
        if self.ood_dataset or self.ood_samples:
            ...
            full_dataset = ind_data + ood_data
        else:
            full_dataset = ind_data
        ...
        if self.ood_dataset:
            ...
            # self.ood_idxs = ood_idxs[:adjusted_ood_len]
    ...
    def train_dataloader(self, main_dataset):
    ...
    def val_dataloader(self, main_dataset, data_idxs):
    ...
    def test_dataloader(self, main_dataset, data_idxs):
    ...
    def ood_val_dataloader(self, main_dataset, val_idxs):
